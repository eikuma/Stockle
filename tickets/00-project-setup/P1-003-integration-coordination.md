...
- [ ] Week 4: 要約生成機能統合テスト
- [ ] Week 5: 全機能統合テスト
- [ ] Week 6: E2Eテスト・デプロイテスト

### 3. API仕様書管理
- [ ] OpenAPI仕様書の作成・更新
- [ ] フロントエンド・バックエンド間の仕様調整
- [ ] APIドキュメントの自動生成設定
- [ ] Postmanコレクション作成
- [ ] モックサーバーの構築
...
## チェックポイント
- [ ] Member 1: Next.js基盤 + shadcn/ui セットアップ完了
- [ ] Member 2: Go基盤 + MySQL + 基本認証API完了
- [ ] Member 3: AI統合基盤 + Groq/Claude API接続確認完了
- [ ] PdM: CI/CD + Docker環境 + API文書テンプレート完了
