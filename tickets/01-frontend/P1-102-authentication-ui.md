...
### 1. NextAuth.js設定
- [ ] NextAuth.js の設定ファイル作成
- [ ] Google OAuth プロバイダーの設定
- [ ] JWT + Database セッション戦略の設定
- [ ] カスタムページの設定
- [ ] セッション管理の設定
...
- [ ] `/auth/reset-password` - 新パスワード設定ページ
- [ ] `/auth/verify-email` - メール確認ページ
...
- [ ] `GoogleSignInButton` - Google認証ボタン
